...
if(isset($_FILES['upload_documento'])){
    ...
    //Recebendo dados do formulario de inserir certificado
    ...
    $sql = "INSERT INTO certificados (nome_documento, tipo_atividade, qtde_horas, file_nome, file_type, file_date) VALUES (:nome_doc, :tipo_atividade, :qtde_horas, :file_nome, :file_type, :file_date)";
